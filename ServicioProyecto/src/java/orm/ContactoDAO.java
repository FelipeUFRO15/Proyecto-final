...
public class ContactoDAO {
	...
	public static boolean save(orm.Contacto contacto) throws PersistentException {
		try {
			orm.ProyectoFinalPersistentManager.instance().saveObject(contacto);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Contacto contacto) throws PersistentException {
		try {
			orm.ProyectoFinalPersistentManager.instance().deleteObject(contacto);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(orm.Contacto contacto) throws PersistentException {
		try {
			orm.ProyectoFinalPersistentManager.instance().getSession().refresh(contacto);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Contacto contacto) throws PersistentException {
		try {
			orm.ProyectoFinalPersistentManager.instance().getSession().evict(contacto);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
