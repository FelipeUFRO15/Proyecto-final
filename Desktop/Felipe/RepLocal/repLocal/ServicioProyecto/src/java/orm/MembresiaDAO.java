...
public class MembresiaDAO {
	public static Membresia loadMembresiaByORMID(int uid_Memb) throws PersistentException {
		try {
			PersistentSession session = orm.ProyectoFinalPersistentManager.instance().getSession();
			return loadMembresiaByORMID(session, uid_Memb);
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static Membresia getMembresiaByORMID(int uid_Memb) throws PersistentException {
		try {
			PersistentSession session = orm.ProyectoFinalPersistentManager.instance().getSession();
			return getMembresiaByORMID(session, uid_Memb);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Membresia loadMembresiaByORMID(int uid_Memb, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = orm.ProyectoFinalPersistentManager.instance().getSession();
			return loadMembresiaByORMID(session, uid_Memb, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Membresia getMembresiaByORMID(int uid_Memb, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = orm.ProyectoFinalPersistentManager.instance().getSession();
			return getMembresiaByORMID(session, uid_Memb, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Membresia loadMembresiaByORMID(PersistentSession session, int uid_Memb) throws PersistentException {
		try {
			return (Membresia) session.load(orm.Membresia.class, new Integer(uid_Memb));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Membresia getMembresiaByORMID(PersistentSession session, int uid_Memb) throws PersistentException {
		try {
			return (Membresia) session.get(orm.Membresia.class, new Integer(uid_Memb));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Membresia loadMembresiaByORMID(PersistentSession session, int uid_Memb, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Membresia) session.load(orm.Membresia.class, new Integer(uid_Memb), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Membresia getMembresiaByORMID(PersistentSession session, int uid_Memb, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Membresia) session.get(orm.Membresia.class, new Integer(uid_Memb), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static boolean save(orm.Membresia membresia) throws PersistentException {
		try {
			orm.ProyectoFinalPersistentManager.instance().saveObject(membresia);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Membresia membresia) throws PersistentException {
		try {
			orm.ProyectoFinalPersistentManager.instance().deleteObject(membresia);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(orm.Membresia membresia) throws PersistentException {
		try {
			orm.ProyectoFinalPersistentManager.instance().getSession().refresh(membresia);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Membresia membresia) throws PersistentException {
		try {
			orm.ProyectoFinalPersistentManager.instance().getSession().evict(membresia);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
