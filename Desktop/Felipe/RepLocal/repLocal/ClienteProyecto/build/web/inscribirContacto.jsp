<%-- 
    Document   : inscribirContacto
    Created on : 27-06-2016, 17:54:10
    Author     : Felipe
--%>
...
<html>
    <head>
            <title>Inscribir Contacto</title>
    ...
    <body style="background-color:burlywood;">
        ...
        <div class = "container">
            <div class = "jumbotron" style = "background-color:bisque;">
                <form class = "form-horizontal" method = "post" action = "InscribirContacto" id = "formRegistroTrabajador">
                    <center>
                        <div class = "row">
                            <div class = "col-sm-12">
                                <center>
                                    <h2>
                                        <b><font face = "Calibri light" size = "10" color = "burlywood">Inscribir Contacto en Grupo</font></b>
                                    </h2>
                                </center>
                            </div>
                        </div>
                        ...
                        <div class = "row">
                            <div class = "col-sm-12">
                                <center><button type = "submit" class = "btn btn-danger btn-lg"><font color = "burlywood">Inscribir</font></button></center>
                            </div>
                        </div>
                </form>
            </div>
