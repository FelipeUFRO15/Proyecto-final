                    ...
                    <center>
                        ...
                        <div class = "col-sm-8">
                            <div class = "form-group">
                                ...
                                <div class = "col-sm-7">
                                    <input type = "text" class = "form-control" id = "nombre_Cont" placeholder = "nombre contacto" name = "nombre_Cont" pattern = "[a-zA-ZáéíóúñÑ]{2,20}" required>
                                </div>
                            </div>
                            <div class = "form-group">
                                ...
                                <div class = "col-sm-7">
                                    <input type = "text" class = "form-control" id = "apellido_Cont" placeholder = "apellido contacto" name = "apellido_Cont" pattern = "[a-zA-ZáéíóúñÑ]{2,20}" required>
                                </div>
                            </div>
                            <div class = "form-group">
                            ...
                            <div class = "form-group">
                                ...
                                <div class = "col-sm-7">
                                    <input type = "text" class = "form-control" id = "telefono_Cont" placeholder = "teléfono contacto" name = "telefono_Cont" pattern = "\d{6,10}" required>
                                </div>
                            </div>
                            <div class = "form-group">
                                ...
                                <div class = "col-sm-7">
                                    <input type = "text" class = "form-control" id = "ciudad_Cont" placeholder = "ciudad contacto" name = "ciudad_Cont" pattern = "[a-zA-ZáéíóúñÑ]*"/>
                                </div>
                            </div>
                            <div class = "form-group">
                                <label for = "organizacion_Cont" class = "col-sm-5 control-label"><font face = "Calibri light" size = "4" color = "burlywood">Organización del contacto:</font></label>
                                <div class = "col-sm-7">
                                    <input type = "text" class = "form-control" id = "organizacion_Cont" placeholder = "organización contacto" name = "organizacion_Cont"/>
                                </div>
                            </div>
                            <div class = "form-group">
                                <label for = "imagen_Cont" class = "col-sm-5 control-label"><font face = "Calibri light" size = "4" color = "burlywood">Imagen del contacto (URL o dirección archivo):</font></label>
                                <div class = "col-sm-7">
